% Segmentation from ground-truth figure/ground map.
function S = segment_gt_glob(gt_glob)
   % extract region labeling
   [vals,ia,ic] = unique(gt_glob);
   seg = reshape(ic,size(gt_glob));
